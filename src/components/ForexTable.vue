...
import { getAllBaseCurrency, getAllBaseRegion, getAllQuoteCurrency, getAllQuoteRegion, getForexTableData } from '@/apis/forex';
...
const forexTableFormData = ref<ForexTableForm>({
  baseRegion: '',
  baseCurrency: '',
  quoteRegion: '',
  quoteCurrency: '',
...
onMounted(() => {
  fetchPageData(forexTableFormData.value, 1);
});

const onPageChange = (current: number) => {
  fetchPageData(forexTableFormData.value, current);
}
            ...
            <a-row :gutter="14">
              <a-col :span="14">
                <a-form-item :label="'基础货币所属国家/地区'">
                  <a-select v-model="forexTableFormData.baseRegion" :options="baseRegionOptions" :placeholder="''" />
                </a-form-item>
              </a-col>
              <a-col :span="10">
                <a-form-item :label="'基础货币名称'">
                  <a-select v-model="forexTableFormData.baseCurrency" :options="baseCurrencyOptions"
                    :placeholder="''" />
                </a-form-item>
              </a-col>
            </a-row>
            ...
            <a-row :gutter="14">
              <a-col :span="14">
                <a-form-item :label="'报价货币所属国家/地区'">
                  <a-select v-model="forexTableFormData.quoteRegion" :options="quoteRegionOptions" :placeholder="''" />
                </a-form-item>
              </a-col>
              <a-col :span="10">
                <a-form-item :label="'报价货币名称'">
                  <a-select v-model="forexTableFormData.quoteCurrency" :options="quoteCurrencyOptions"
                    :placeholder="''" />
                </a-form-item>
              </a-col>
            </a-row>
