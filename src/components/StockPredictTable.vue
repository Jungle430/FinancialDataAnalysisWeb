...
import { getStockPredictData, getStockPredictAttributes } from "@/apis/financialDataAnalysis";
                        ...
                        <a-row :gutter="16">
                            <a-col :span="7">
                                <a-form-item :label="'国家/地区'">
                                    <a-select v-model="stockTableFormData.region" :options="regionOptions"
                                        :placeholder="''" />
                                </a-form-item>
                            </a-col>
                            <a-col :span="7">
                                <a-form-item :label="'货币'">
                                    <a-select v-model="stockTableFormData.currency" :options="currencyOptions"
                                        :placeholder="''" />
                                </a-form-item>
                            </a-col>
                            <a-col :span="10">
